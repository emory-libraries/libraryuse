...
env.project = 'libraryuse'
env.rev_tag = ''
env.git_rev = ''
env.remote_path = '/home/httpd/sites/libraryuse'
env.url_prefix = None
...
def configure(path=None, user=None, url_prefix=None, remote_proxy=None):
    ...
    env.version = libraryuse.__version__
    config_from_git()
...
def config_from_git():
    ...
    if libraryuse.__version_info__[-1]:
...
def deploy(path=None, user=None, url_prefix='', remote_proxy=None):
    ...
    Parameters:
      path: base deploy directory on remote host; deploy expects a
            ...
            Default: env.remote_path = /home/httpd/sites/libraryuse
    ...
    Example usage:
      fab deploy:/home/libraryuse/,bg -H servername
